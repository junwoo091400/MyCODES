...
private:
	...
	//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
	const static unsigned char Default_Compression_Ratio = 5;
	const unsigned char Default_Encryption_BitAllocate[Default_Compression_Ratio] = { 2,1,2,1,2 };
	unsigned char Compression_Ratio = 8;
	unsigned char Encryption_BitAllocate[8] = {1,1,1,1,1,1,1,1};
	//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!//
